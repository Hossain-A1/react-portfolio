import img from "..//assets/portfolio_images/images/protfolio-img.jpeg";
...
const About = ({ isDarkMode }) => {
  return (
    ...
    >
      ...
      {/* Main Content */}
      <div className='flex flex-col items-center justify-center lg:flex-row lg:items-start gap-8'>
        <div className='overflow-hidden bg-slate-400  '>
          <img
            className='sm:object-cover h-full md:h-96 md:w-[30rem] w-full'
            src={img}
            alt='dev'
          />
        </div>
        ...
        <div className=''>
          ...
          Throughout my career, I’ve contributed to impactful projects and worked with diverse teams.`}
            ...
            <div className='sm:flex max-xl:flex-wrap max-lg:justify-center max-lg:items-center gap-4'>
              {/* Languages */}
              ...
              <div className='border w-60 h-[11.5rem] rounded-lg p-6 text-center shadow-md hover:shadow-lg hover:scale-105 duration-300 transition-all'>
                ...
                >
                  Built more than 15 major projects
                </p>
              </div>
            </div>
            ...
            <div className='mt-10  '>
              <h3
                className={`text-2xl font-semibold ${
                  isDarkMode ? "text-slate-50" : "text-gray-500"
                } mt-5`}
              >
                Tools I Use
              </h3>
              <div className='flex mt-4 gap-4'>
                <img
                  className=' max-sm:w-12 w-16 shadow-md hover:scale-105 duration-300 border rounded-md p-2'
                  src={vscode}
                  alt=''
                />
                <img
