...
const Navbar = ({ isDarkMode, toggleTheme }) => {
  ...
  return (
    <div
      className={`containers flex justify-between items-center py-2 border-b lg:sticky top-0 z-20 ${
    ...
    >
      ...
      <div className='flex items-center gap-3 mr-2'>
        ...
        <div
          className={`fixed top-0 right-0 bottom-0 overflow-hidden transition-all ${
